import type {DidCreateResult, InitConfig} from '@aries-framework/core'
...
public async importDid() { //wallet에 있는 값을 가져온다. 없을경우 생성
    this.anonCredsIssuerId=await this.createDid();
}

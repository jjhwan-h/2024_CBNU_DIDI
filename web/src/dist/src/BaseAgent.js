    ...
    createDid() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.agent.dids.import({
                did: process.env.BCOVRINENDORSERDID,
                privateKeys: [
                    {
                        keyType: core_1.KeyType.Ed25519,
                        privateKey: core_1.TypedArrayEncoder.fromString(process.env.BCOVRINSEED),
                    },
                ],
                overwrite: true,
            });
            const indyDocument = yield this.agent.dids.create({
                method: 'indy',
            ...
            const did = indyDocument.didState.did;
            return did;
        });
    }
    importDid() {
        return __awaiter(this, void 0, void 0, function* () {
            this.anonCredsIssuerId = yield this.createDid();
        });
    }
    initializeAgent() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.agent.initialize();
            console.log((0, OutputClass_1.greenText)(`\nAgent ${this.name} created!\n`));
        });
    }
}
...
const getAskarAnonCredsIndyModules = () => {
    ...
    return {
        ...
        ariesAskar: new askar_1.AskarModule({
